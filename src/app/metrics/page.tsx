  ...
  return (
    <main className="page-enter mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gradient">Métricas</h1>
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="card kpi-card kpi-card--primary animate-fade-in stagger-1 p-4">
          ...
          <div className="text-3xl font-bold text-[var(--color-text-primary)]">{scoreStats.total}</div>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        {/* Score distribution */}
        <div className="card-elevated animate-fade-in-up p-4" style={{ animationDelay: '60ms' }}>
          <h2 className="mb-3 text-sm font-semibold text-[var(--color-text-secondary)]">
        ...
        {/* Verdict */}
        <div className="card-elevated animate-fade-in-up p-4" style={{ animationDelay: '120ms' }}>
          <h2 className="mb-3 text-sm font-semibold text-[var(--color-text-secondary)]">
            Veredictos
          </h2>
        ...
        {/* Platform */}
        <div className="card-elevated animate-fade-in-up p-4" style={{ animationDelay: '180ms' }}>
          <h2 className="mb-3 text-sm font-semibold text-[var(--color-text-secondary)]">
            Plataformas
          </h2>
        ...
        {/* Profile angles */}
        <div className="card-elevated animate-fade-in-up p-4" style={{ animationDelay: '240ms' }}>
          <h2 className="mb-3 text-sm font-semibold text-[var(--color-text-secondary)]">
            Ángulos de perfil
          </h2>
        ...
        {/* Daily intake */}
        <div className="card-elevated animate-fade-in-up p-4" style={{ animationDelay: '300ms' }}>
          <h2 className="mb-3 text-sm font-semibold text-[var(--color-text-secondary)]">
            Leads por día
          </h2>
        ...
        <div className="card-elevated animate-fade-in-up p-4" style={{ animationDelay: '360ms' }}>
          <h2 className="mb-3 text-sm font-semibold text-[var(--color-text-secondary)]">
            Origen de leads
          </h2>
