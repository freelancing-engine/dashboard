...
const LEAD_3 = {
  ...
  score_technical_fit: 10,
  score_budget_attractiveness: 5,
  score_feasibility: 5,
  score_timeline_fit: 4,
  score_client_reliability: 6,
  score_competition_risk: 3,
  score_strategic_value: 4,
  score_close_probability: 3,
  score_total: 40,
  verdict: "ignore",
